...
public class CustomerRepository implements ICustomerRepository {
    ...
    private static final String DELETE_CUSTOMER = "UPDATE customer SET `status`=0 WHERE id = ?;";
    private static final String SELECT_CUSTOMER = "SELECT * FROM customer WHERE id =? and status=1;";
